...
layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        J = function (i) {
            if (i = i || {}, window.Notification) if ("granted" === Notification.permission) {
                new Notification(i.title || "", {
                    body: i.content || "",
                    icon: i.avatar || "localhost/logogo.png"
                })
        ...
        ti = {
                ...
                var a = x.find(".layui-layim-search"),
                    ...
                    n = function (i) {
                        ...
                        if ("" === a) ti.tab(0 | ti.tab.index);
                            ...
                            else o = '<li class="layim-null">no search result</li>';
                            e.html(o),
                                ti.tab(3)
                        }
                    };
            ...
            about: function () {
                t.alert("Version： " + a + '<br>restuarant：<a href="http://layim.layui.com" target="_blank">layim.layui.com</a>', {
                    title: "about LayIM",
                    shade: !1
                })
            },
            ...
            media: function (i) {
                var a = i.data("type"),
                    ...
                    l = _();
                t.prompt({
                    title: "please network" + n[a] + "address",
                    shade: !1,
            ...
            playAudio: function (i) {
                ...
                return i.data("error") ? t.msg("audio error") : e.play ? void(i.attr("status") ? n() : (a || (e.src = i.data("src")), e.play(), i.attr("status", "pause"), i.data("audio", e), i.find("i").html("&#xe651;"), e.onended = function () {
                    n()
                }, e.onerror = function () {
                    t.msg("audio error"),
                        i.data("error", !0),
            ...
            playVideo: function (i) {
                ...
                }))) : t.msg("your brower doesn't support video function")
            },
            chatLog: function (i) {
                var a = _();
                return j.base.chatLog ? (t.close(ti.chatLog.index), ti.chatLog.index = t.open({
                    type: 2,
                    maxmin: !0,
                    title: "with " + a.data.name + " history",
                    area: ["450px", "100%"],
                    shade: !1,
                    offset: "rb",
                    skin: "layui-box",
            ...
            menuHistory: function (i, a) {
                var n = layui.data("layim")[j.mine.id] || {},
                    ...
                    d = '<li class="layim-null">no history</li>';
                if ("one" === s) {
                    var r = n.history;
